...
const Zurag = () => {
   const [matches500, setMatches5] = useState(false);
    ...
    return<div className={css.ZuragContainer}>
      ...
      <div style={{ display: "flex", gap: "20px", flexWrap: "wrap", justifyContent: "center" }}>
        <Image src="/img/zr3.webp" width={matches500 ? 280 : 160}  alt="magic"/>
        <Image src="/img/zr4.webp" width={matches500 ? 280 : 160}  alt="magic"/>
      </div>
